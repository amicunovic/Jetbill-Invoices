...
#pyinstaller --onefile FILE NAME.py --> to create an exe program

file_name = input("Please enter the new excel file name in which you would like to save the data  ")
br_inv = 0

list_of_invoices = []

dirs = os.listdir(os.getcwd()) # what directory to search os.getcwd() \ os.listdir --> lists all the files \ Instead of os.getcwd you can also write r"c:..."

# This would print all the files and directories
for file in dirs:
	if ".pdf" in file:
		list_of_invoices.append(file)

last_invoice = len(list_of_invoices) - 1
...
while br_inv <= last_invoice:
	try:
		opened_pdf = PyPDF2.PdfFileReader(list_of_invoices[br_inv], 'rb')
